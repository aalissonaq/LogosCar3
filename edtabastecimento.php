<?php
    ...
    if(count($_POST)>0){
        //recebe data cheia
        $dataFull = str_replace("T"," ", $_POST['inputEdtDataAbastecimento']);
        ...
        if(count($dividoHorario)<3){
            ...
            $dataAbastecimento = str_replace("T"," ",$_POST['inputEdtDataAbastecimento']).':00';
        } else{
            //deixa como está
        ...
        $valorTotal = $_POST['inputEdtValorTotal'];
        $km = $_POST['inputEdtKM'];
